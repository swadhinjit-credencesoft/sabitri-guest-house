  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="pb-24">
      ...
      <CinematicHero
        ...
        altText="Aurelia Dining"
        eyebrow="Three Concepts, One Standard"
        title={
          <>
            Culinary<br /><span className="text-amber-400 italic">Journeys</span>
          </>
        }
        subtitle="Every meal is theatre. Every dish, a story."
      ...
      <section ref={morningRef} className="relative h-[80vh] flex items-center overflow-hidden grain-overlay">
        <motion.div style={{ y: morningParallax }} className="absolute inset-0 z-0">
          <img src="/images/experiences-hero.png" alt="Aurelia morning ritual" className="w-full h-full object-cover scale-110" />
        ...
        <div className="relative z-10 container mx-auto px-4 md:px-6 lg:px-8">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.9 }} className="max-w-xl">
            <div className="flex items-center gap-2 mb-7">
              ...
              <p className="text-amber-400 uppercase tracking-[0.35em] text-xs">The Morning Ritual</p>
            </div>
            <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white leading-tight mb-7 text-shadow-hero">
              Every Day Begins<br />with <span className="text-amber-400 italic">Ceremony</span>
            </h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-16 items-start">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }}>
              <div className="flex items-center gap-3 mb-7">
                ...
                <p className="text-amber-400 uppercase tracking-[0.3em] text-xs">The Cellar</p>
              </div>
              <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white leading-tight mb-7">
                A Cellar Worth<br /><span className="text-amber-400 italic">Exploring</span>
              </h2>
              <p className="text-stone-400 text-base md:text-lg leading-relaxed mb-6">
                Our sommelier, Pierre-Luc Renard, curates a cellar of over 2,400 labels — from verticals of Burgundy Grand Cru to rare natural wines from volcanic archipelagos.
              </p>
              <p className="text-stone-500 text-base leading-relaxed mb-8">
                Private cellar tastings, food and wine pairing dinners, and a "Blind Vintage" experience are available exclusively for Aurelia guests.
              </p>
              <Link href="/contact">
                <Button variant="outline" className="rounded-full border-amber-400/30 text-amber-400 hover:bg-amber-400/10 px-8 uppercase tracking-widest text-xs" data-testid="button-cellar-tasting">Book a Tasting</Button>
              </Link>
            </motion.div>
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} className="space-y-3">
              ...
              <p className="text-stone-700 text-xs text-center pt-2 uppercase tracking-widest">+ 2,400 further labels available</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-28 md:py-36 overflow-hidden grain-overlay">
        <div className="absolute inset-0 z-0">
          <img src="/images/dining-saltwater.png" alt="Chef Arnaud Villeneuve" className="w-full h-full object-cover" />
          ...
          <div className="max-w-2xl">
            <motion.div initial={{ opacity: 0, y: 25 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
              <div className="flex items-center gap-3 mb-7">
                ...
                <p className="text-amber-400 uppercase tracking-[0.3em] text-xs">Chef Spotlight</p>
              </div>
              <h2 className="font-serif text-5xl md:text-6xl lg:text-7xl text-white mb-7 leading-[0.9] text-shadow-hero">
                Chef Arnaud<br /><span className="text-amber-400 italic">Villeneuve</span>
              </h2>
              <p className="text-white/65 text-base md:text-lg leading-relaxed mb-7">
                From the kitchens of Paris to the fish markets of Tokyo, Chef Arnaud spent twenty years refining a philosophy built on restraint and reverence. At Aurelia, that philosophy found its canvas.
              </p>
