...
export const metadata: Metadata = {
  ...
  keywords: [
    "Sabitri Guest House",
    "Sabitri Guest House Puri",
    "Sabitri Lodge Puri",
    "Sabitri Homestay Puri",
    "Sabitri Guest House Booking",
    "Sabitri Guest House Contact Number",
    "Sabitri Guest House Website",
    "Sabitri Guest House Rooms",
    "Sabitri Guest House Reviews",
    "Sabitri Guest House Price",
    "budget guest house in Puri",
    "best guest house in Puri",
    "affordable guest house in Puri",
    "family guest house in Puri",
    "guest house near Jagannath Temple",
    "budget hotel in Puri",
    "affordable hotel in Puri",
    "best budget hotel in Puri",
    "cheap hotel in Puri",
    "low cost hotel in Puri",
    "budget accommodation in Puri",
    "best stay in Puri",
    "hotel booking Puri",
    "rooms in Puri",
    ...
    "rooms near Jagannath Temple",
    "hotel walking distance from Jagannath Temple",
    "accommodation near Jagannath Temple",
    "budget stay near Jagannath Temple",
    "best hotel near Jagannath Temple",
    "family hotel near Jagannath Temple",
    "lodge near Jagannath Temple",
    "hotel near Puri Beach",
    "hotel near golden beach Puri",
    "guest house near sea beach",
    "budget hotel near sea beach",
    "beachside guest house Puri",
    "hotel near Swargadwar Beach",
    "hotel near Puri Railway Station",
    "guest house near Puri Railway Station",
    "budget hotel near railway station",
    "rooms near railway station",
    "family hotel in Puri",
    "family guest house in Puri",
    "safe family stay in Puri",
    "family rooms in Puri",
    "large family room Puri",
    "budget family hotel",
    "couple friendly hotel Puri",
    "couple friendly guest house Puri",
    "safe couple stay Puri",
    "budget couple hotel Puri",
    "AC rooms in Puri",
    "non AC rooms in Puri",
    "free WiFi hotel Puri",
    "parking hotel Puri",
    "clean rooms in Puri",
    "comfortable stay Puri",
    "best place to stay in Puri",
    "accommodation for Jagannath Temple visit",
    "stay during Rath Yatra",
    "hotel for Jagannath Darshan",
    "budget stay for pilgrims",
    "pilgrimage stay Puri",
    "hotel under 1000 in Puri",
    "cheap stay in Puri",
    "low budget hotel Puri",
    "affordable rooms near Jagannath Temple",
    "best value hotel Puri",
    "hotel in Grand Road Puri",
    "guest house in Bada Danda Puri",
    "where to stay in Puri",
    "best budget hotel in Puri",
    "cheap rooms in Puri",
    "family hotel near Jagannath Temple",
    "hotel near sea beach",
    "best accommodation in Puri",
    "best budget guest house near Jagannath Temple Puri",
    "affordable hotel within walking distance of Jagannath Temple",
    "family guest house near Puri Temple",
    "budget hotel near Puri Beach and Jagannath Temple",
    "AC rooms near Jagannath Temple Puri",
    "guest house with parking near Jagannath Temple",
    "hotel for family trip to Puri",
    "clean budget hotel in Puri",
    "direct booking guest house Puri",
    "best place to stay for Jagannath Darshan",
    "book guest house in Puri",
    "book hotel in Puri",
    "online hotel booking Puri",
    "direct hotel booking Puri",
    ...
    "Puri weekend trip",
    "Puri vacation guide",
    "book hotel near Jagannath Temple",
    "book guest house in Puri",
    "hotel near Golden Beach Puri",
    "hotel near Konark Sun Temple",
    "hotel near Chilika Lake",
    "where to stay in Puri",
    "best hotel for Jagannath Darshan",
    "family stay in Puri",
    "budget hotel near beach",
    "hotel near Puri Railway Station",
    "hotel near Puri Bus Stand",
    "best guest house for pilgrims",
    "best hotel for tourists",
    "budget accommodation in Puri",
    "hotels for families in Puri",
    "couple friendly hotel Puri",
    "hotels near tourist attractions Puri",
    "best place to stay in Puri",
    "weekend stay in Puri",
    "holiday stay in Puri",
    "book hotel in Puri online",
    "AC rooms near Jagannath Temple",
    "family rooms in Puri",
    "hotel with free parking Puri",
    "hotel with free WiFi Puri",
    "hotel near beach and temple Puri",
    "budget hotel with online booking Puri",
    "best price hotel in Puri",
    "direct hotel booking Puri",
    "Puri hotel booking",
    "guest house near Jagannath Temple",
    "budget guest house Puri",
    "cheapest hotel in Puri",
    "Puri accommodation near temple",
    "hotel for family trip to Puri",
    "Puri darshan stay",
    "pilgrim accommodation Puri",
    "Rath Yatra accommodation Puri",
    "Puri festival stay",
  ],
  ...
  "@graph": [
    ...
    },
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 6, "name": "Blog", "item": "https://sabitriguesthouse.in/blog" },
        { "@type": "ListItem", "position": 7, "name": "Contact Us", "item": "https://sabitriguesthouse.in/contact" },
      ],
    },
    {
      "@type": "LocalBusiness",
